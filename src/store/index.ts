...
const EXPEDIENTES_DEMO: Expediente[] = [
  makeExpediente({
    id: 'exp-001',
    numero_siniestro: '696213',
    fecha_siniestro: '2026-08-10',
    hora_siniestro: '14:35',
    fecha_apertura: '2026-08-10T09:30:00Z',
    aseguradora: 'Seguros Afirme',
    poliza: 'AF-2026-00123',
    folio_dua: 'DUA-696213',
    reporte: {
      numero_reporte: 'AFI-2026-08-696213',
      fecha_reporte: '2026-08-10T09:00:00Z',
      hora_siniestro: '14:35',
      ubicacion_siniestro: 'Av. Salvador Nava Martínez 3025, San Luis Potosí, SLP',
      descripcion_inicial: 'Colisión entre dos vehículos. Asegurado indica que fue alcanzado por detrás en semáforo.',
      contacto_aseguradora: 'Lic. Roberto Alvarado',
      prioridad: 'NORMAL',
    },
    asegurado: { nombre: 'Roberto Gutiérrez Torres', telefono: '4441234567' },
    vehiculo_asegurado: { placas: 'ABC-123', vin: '3VWFE21C04M000001', marca: 'Nissan', modelo: 'Versa', año: '2023', color: 'Blanco' },
    tiene_tercero: true,
    tercero: { nombre: 'Laura Pérez Vega', telefono: '4449876543' },
    vehiculo_tercero: { placas: 'XYZ-789', marca: 'Toyota', modelo: 'Corolla', año: '2021', color: 'Gris' },
    created_by: 'u8',
    assigned_to: 'u2',
    assigned_at: '2026-08-10T09:35:00Z',
    assigned_by: 'u8',
    assignment_notes: 'Zona norte. Cliente solicita atención rápida. Aseguradora: llamar al Lic. Alvarado al terminar.',
    reviewer_id: 'u5',
    status: 'EN_REVISION',
    integration_percent: 82,
    validation_percent: 45,
    observaciones_abiertas: 3,
    submitted_at: '2026-08-11T14:00:00Z',
  }),
  makeExpediente({
    id: 'exp-002',
    numero_siniestro: '696350',
    fecha_siniestro: '2026-08-15',
    hora_siniestro: '09:12',
    fecha_apertura: '2026-08-15T11:00:00Z',
    aseguradora: 'General de Seguros',
    poliza: 'GS-2026-00456',
    folio_dua: 'DUA-696350',
    reporte: {
      numero_reporte: 'GS-2026-08-350',
      fecha_reporte: '2026-08-15T10:45:00Z',
      hora_siniestro: '09:12',
      ubicacion_siniestro: 'Carretera 57 km 185, Salida a Querétaro, SLP',
      descripcion_inicial: 'Volcadura. Sin lesionados. Vehículo asegurado perdida total probable.',
      prioridad: 'URGENTE',
    },
    asegurado: { nombre: 'Elena Morales Cruz', telefono: '4448765432' },
    vehiculo_asegurado: { placas: 'DEF-456', marca: 'Volkswagen', modelo: 'Jetta', año: '2022', color: 'Rojo' },
    tiene_tercero: false,
    created_by: 'u9',
    assigned_to: 'u3',
    assigned_at: '2026-08-15T11:05:00Z',
    assigned_by: 'u9',
    assignment_notes: 'URGENTE — posible pérdida total. Documentar daños con detalle.',
    status: 'EN_INTEGRACION',
    integration_percent: 35,
    validation_percent: 0,
    observaciones_abiertas: 0,
  }),
  makeExpediente({
    id: 'exp-003',
    numero_siniestro: '696501',
    fecha_siniestro: '2026-08-18',
    hora_siniestro: '16:48',
    fecha_apertura: '2026-08-18T16:45:00Z',
    aseguradora: 'Seguros El Águila',
    poliza: 'EA-2026-00789',
    folio_dua: 'DUA-696501',
    reporte: {
      numero_reporte: 'EA-2026-08-501',
      fecha_reporte: '2026-08-18T16:30:00Z',
      hora_siniestro: '16:48',
      ubicacion_siniestro: 'Calle Galeana 240, Zona Centro, Aguascalientes',
      descripcion_inicial: 'Colisión frontal. Ambos conductores presentan lesiones menores.',
      prioridad: 'URGENTE',
    },
    asegurado: { nombre: 'Miguel Ángel Flores', telefono: '4492345678' },
    vehiculo_asegurado: { placas: 'GHI-789', marca: 'KIA', modelo: 'Sportage', año: '2024', color: 'Azul' },
    tiene_tercero: true,
    tercero: { nombre: 'Fernando Castro' },
    vehiculo_tercero: { placas: 'JKL-012', marca: 'Honda', modelo: 'Civic', año: '2020', color: 'Negro' },
    created_by: 'u8',
    assigned_to: 'u4',
    assigned_at: '2026-08-18T16:50:00Z',
    assigned_by: 'u8',
    assignment_notes: 'Zona Aguascalientes. Hay lesionados — solicitar pases médicos.',
    reviewer_id: 'u6',
    status: 'VALIDADO',
    ...
    validated_at: '2026-08-20T15:00:00Z',
  }),
  makeExpediente({
    id: 'exp-004',
    numero_siniestro: '696620',
    fecha_siniestro: '2026-08-20',
    hora_siniestro: '07:55',
    fecha_apertura: '2026-08-20T08:00:00Z',
    aseguradora: 'Seguros Afirme',
    poliza: 'AF-2026-00890',
    folio_dua: 'DUA-696620',
    reporte: {
      numero_reporte: 'AFI-2026-08-696620',
      fecha_reporte: '2026-08-20T07:45:00Z',
      hora_siniestro: '07:55',
      ubicacion_siniestro: 'Prolongación Karakorum s/n, Lomas 4a sección, SLP',
      descripcion_inicial: 'Choque lateral en cruce. Sin lesionados.',
      prioridad: 'NORMAL',
    },
    asegurado: { nombre: 'Patricia Hernández', telefono: '4445678901' },
    vehiculo_asegurado: { placas: 'MNO-345', marca: 'Chevrolet', modelo: 'Aveo', año: '2022', color: 'Plata' },
    tiene_tercero: false,
    created_by: 'u8',
    assigned_to: 'u2',
    assigned_at: '2026-08-20T08:05:00Z',
    assigned_by: 'u8',
    status: 'CON_OBSERVACIONES',
    integration_percent: 65,
    validation_percent: 20,
    observaciones_abiertas: 5,
    submitted_at: '2026-08-21T09:00:00Z',
  }),
  // Asignado sin iniciar — recién asignado al campo
  makeExpediente({
    id: 'exp-005',
    numero_siniestro: '696788',
    fecha_siniestro: '2026-08-22',
    hora_siniestro: '21:10',
    fecha_apertura: '2026-08-22T21:30:00Z',
    aseguradora: 'General de Seguros',
    poliza: 'GS-2026-01200',
    folio_dua: '',
    reporte: {
      numero_reporte: 'GS-2026-08-788',
      fecha_reporte: '2026-08-22T21:20:00Z',
      hora_siniestro: '21:10',
      ubicacion_siniestro: 'Blvd. Antonio Rocha Cordero 625, SLP',
      descripcion_inicial: 'Colisión trasera en zona de alta velocidad.',
      prioridad: 'URGENTE',
    },
    asegurado: { nombre: 'Armando Cisneros Vidal', telefono: '4447654321' },
    vehiculo_asegurado: { placas: 'PQR-567', marca: 'Toyota', modelo: 'Hilux', año: '2023', color: 'Negro' },
    tiene_tercero: true,
    tercero: { nombre: 'Por confirmar en campo' },
    vehiculo_tercero: { placas: 'STU-890', color: 'Blanco' },
    created_by: 'u9',
    assigned_to: 'u10',
    assigned_at: '2026-08-22T21:32:00Z',
    assigned_by: 'u9',
    assignment_notes: 'URGENTE. Recién reportado. Ajustador va en camino. Datos tercero por confirmar en escena.',
    status: 'ASIGNADO',
    integration_percent: 0,
    validation_percent: 0,
    observaciones_abiertas: 0,
