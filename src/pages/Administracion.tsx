    ...
    <div className="p-4 lg:p-6 space-y-6 max-w-7xl mx-auto animate-fadeIn">
      ...
      <div className="flex gap-2 border-b border-slate-200">
        ...
        <TabButton active={tab === 'auditoria'} onClick={() => setTab('auditoria')}>
          <span className="flex items-center gap-1.5"><BarChart3 className="w-4 h-4" /> Bitácora de Auditoría (SIEM)</span>
        </TabButton>
      ...
      {tab === 'auditoria' && (
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
          <div className="px-6 py-4 border-b border-slate-100 bg-slate-50/50 flex justify-between items-center">
            <div>
              <h2 className="text-sm font-bold text-slate-900">Registro de Auditoría Legal (SEC-014)</h2>
            ...
            <div className="space-y-3 text-xs text-slate-700">
              ...
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-100 flex justify-between items-center">
                <div>
                  ...
                  <div className="text-slate-500">Archivo legal histórico comprimido</div>
                </div>
